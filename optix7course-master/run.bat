...
:: printColor     : whether to enable/disable print color       (1 / 0)
:: buildBeforeRun : whether to enable/disable build before run  (1 / 0)
:: runDir         : the directory to execute the run command
:: runCommand     : the command to be run

set printColor=1
set buildBeforeRun=1
set runDir=.\build\
set runCommand=.\ex10_softShadows.exe
